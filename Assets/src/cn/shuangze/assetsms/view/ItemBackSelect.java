 ...
 * 资产归还界面
 */
public class ItemBackSelect extends JFrame implements ActionListener, ListSelectionListener {
    ...
    private void init() throws Exception {  
        ...
        //面板的布局
        jLabel.setText("资产归还信息：");
        jLabel.setFont(new Font("Dialog", 0, 12));
        jPanel.add(jLabel);
        
        String[][] colValue = assetsTrjn.findAll2();
        if (colValue == null) {
    ...
    public void valueChanged(ListSelectionEvent e){
        JOptionPane.showMessageDialog(null, "无法选中！", "资产归还", JOptionPane.INFORMATION_MESSAGE);
    }
}
